...
float math_util::degrees_to_radians(const float degrees) {
    return degrees  * pi / 180.0f;
}

Vector3 math_util::rotation_to_direction_unit_vector(const Vector3& rotation) {
...
Vector3 math_util::forward_vector(const Entity& entity, const Vector3& scaling_vector, const bool is_safe_for_ped) {
